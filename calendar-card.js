...
class CalendarEvent {
    ...
    get startDateTime() {
        if (this.calendarEvent.start.date) {
            const dateTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.calendarEvent.start.date);
    ...
    get isFullDayEvent() {
        ...
        const start = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.startDateTime);
        const end = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.endDateTime);
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var moment_min_locales__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment/min/locales */ "./node_modules/moment/min/locales.js");
...
/* harmony import */ var _calendar_event__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./calendar-event */ "./src/calendar-event.js");
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./defaults */ "./src/defaults.js");
/* harmony import */ var _index_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-editor */ "./src/index-editor.js");
...
customElements.define('calendar-card-editor', _index_editor__WEBPACK_IMPORTED_MODULE_6__["default"]);


class CalendarCard extends lit_element__WEBPACK_IMPORTED_MODULE_2__["LitElement"] {
  static get properties() {
    return {
      hass: Object,
      config: Object,
  ...
  constructor() {
    ...
    this.content = lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]``;
    this.events = null;
  ...
  setConfig(config) {
    ...
    this.config = Object.assign({}, _defaults__WEBPACK_IMPORTED_MODULE_5__["default"], config);
  }
  ...
  render() {
    (async () => {
      ...
      moment__WEBPACK_IMPORTED_MODULE_0___default.a.locale(this.hass.language);
  ...
  async getAllEvents(entities) {
    ...
    if (this.eventNeedUpdating || moment__WEBPACK_IMPORTED_MODULE_0___default()().diff(this.lastEventsUpdate, 'minutes') >= 15){
      // create url params
      const dateFormat = 'YYYY-MM-DDTHH:mm:ss';
      const today = moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('day');
      ...
      newEvents = [].concat(...allResults).map(event => new _calendar_event__WEBPACK_IMPORTED_MODULE_4__["default"](event));
      ...
      this.lastEventsUpdate = moment__WEBPACK_IMPORTED_MODULE_0___default()();
    }
  ...
  updateCard(eventList) {
    ...
    const calendar = groupedEventsByDay.reduce((htmlTemplate, eventDay) => {
      const momentDay = moment__WEBPACK_IMPORTED_MODULE_0___default()(eventDay.day);

      // for each event in a day create template for that event
      const eventsTemplate = eventDay.events.map((event, index) => lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]`
   ...
   */
  createHeader() {
    if (this.config.title === false) return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]``;
  ...
  buildProgressBar(event) {
    if (!event.startDateTime || !event.endDateTime || event.isFullDayEvent) return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]``;

    const now = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
    const start = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDateTime);
    const end = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.endDateTime);
    if (now.isBefore(start) || now.isSameOrAfter(end) || !start.isValid() || !end.isValid()) return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]``;
  ...
  groupEventsByDay(events) {
    return events.reduce((groupedEvents, event) => {
      const day = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDateTime).format('YYYY-MM-DD');
   ...
   */
  getTimeHtml(event) {
    if (this.config.hideTime === true) return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]``;

    if (event.isFullDayEvent) return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]`<div class="time">All day</div>`;

    const start = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.startDateTime).format(this.config.timeFormat);
    const end = moment__WEBPACK_IMPORTED_MODULE_0___default()(event.endDateTime).format(this.config.timeFormat);
    return lit_element__WEBPACK_IMPORTED_MODULE_2__["html"]`<div class="time">${start} - ${end}</div>`;
  }
